/**
 * Manifest POD Report — CourierWala Operations filter form.
 */
...
const DEF = REPORT_DEFINITIONS.find((r) => r.id === "manifest-pod")!;

export type ManifestPodFiltersProps = OpsFilterProps & {
  reportTypeControl: ReactNode;
};

export function ManifestPodFilters({ reportTypeControl, ...props }: ManifestPodFiltersProps) {
