/**
 * Login Log — CourierWala Operations filter form.
 */
...
const DEF = REPORT_DEFINITIONS.find((r) => r.id === "login-log")!;

export type LoginLogFiltersProps = OpsFilterProps & {
  reportTypeControl: ReactNode;
};

export function LoginLogFilters({ reportTypeControl, ...props }: LoginLogFiltersProps) {
