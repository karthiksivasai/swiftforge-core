...
export const Route = createFileRoute("/utility/excel-import/pod-merging")({
  ...
  component: PodMergingPage,
});

function PodMergingPage() {
  ...
  const handleImport = () => {
    ...
    toast.success("POD merging import started");
  };
  ...
  return (
    <div className="flex min-w-0 flex-col gap-4 p-4 md:p-6">
      <MasterBreadcrumb trail={["Utility", "Excel Import", "POD Merging"]} />

      <Card className="min-w-0 border p-4">
        <button
          type="button"
          onClick={() => toast.success("POD merging template download started")}
