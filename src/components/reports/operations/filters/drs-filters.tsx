/**
 * DRS Report — CourierWala Operations filter form.
 */
...
const DEF = REPORT_DEFINITIONS.find((r) => r.id === "drs-report")!;

export type DrsFiltersProps = OpsFilterProps & {
  reportTypeControl: ReactNode;
};

export function DrsFilters({ reportTypeControl, ...props }: DrsFiltersProps) {
