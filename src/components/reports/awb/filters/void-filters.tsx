/**
 * Void Report — CourierWala AWB Report filter form.
 */
...
const DEF = AWB_REPORT_DEFINITIONS.find((r) => r.id === "void")!;

export type VoidFiltersProps = AwbFilterProps & {
  reportTypeControl: ReactNode;
};

export function VoidFilters({ reportTypeControl, ...props }: VoidFiltersProps) {
