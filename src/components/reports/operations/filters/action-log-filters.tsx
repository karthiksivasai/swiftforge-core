/**
 * Action Log — CourierWala Operations filter form.
 */
...
const DEF = REPORT_DEFINITIONS.find((r) => r.id === "action-log")!;

export type ActionLogFiltersProps = OpsFilterProps & {
  reportTypeControl: ReactNode;
};

export function ActionLogFilters({ reportTypeControl, ...props }: ActionLogFiltersProps) {
