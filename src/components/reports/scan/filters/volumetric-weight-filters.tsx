/**
 * Volumetric Weight Report — CourierWala Scan Report filter form.
 */
...
const DEF = SCAN_REPORT_DEFINITIONS.find((r) => r.id === "volumetric-weight")!;

export type VolumetricWeightFiltersProps = ScanFilterProps & {
  reportTypeControl: ReactNode;
};

export function VolumetricWeightFilters({
  reportTypeControl,
  ...props
}: VolumetricWeightFiltersProps) {
