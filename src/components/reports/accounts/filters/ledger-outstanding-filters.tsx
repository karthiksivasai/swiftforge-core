/**
 * Ledger Outstanding Report — CourierWala Accounts filter form.
 */
...
const DEF = AR_REPORT_DEFINITIONS.find((r) => r.id === "ledger-outstanding")!;

export type LedgerOutstandingFiltersProps = ArFilterProps & {
  reportTypeControl: ReactNode;
};

export function LedgerOutstandingFilters({
  reportTypeControl,
  ...props
}: LedgerOutstandingFiltersProps) {
