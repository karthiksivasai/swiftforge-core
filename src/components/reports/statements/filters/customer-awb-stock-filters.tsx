/**
 * Customer AWB Stock Report — CourierWala Statements filter form.
 */
...
const DEF = STATEMENT_DEFINITIONS.find((r) => r.id === "customer-awb-stock")!;

export type CustomerAwbStockFiltersProps = StmtFilterProps & {
  reportTypeControl: ReactNode;
};

export function CustomerAwbStockFilters({
  reportTypeControl,
  ...props
}: CustomerAwbStockFiltersProps) {
