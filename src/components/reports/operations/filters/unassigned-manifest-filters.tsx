/**
 * Unassigned Manifest Report — CourierWala Operations filter form.
 */
...
const DEF = REPORT_DEFINITIONS.find((r) => r.id === "unassigned-manifest")!;

export type UnassignedManifestFiltersProps = OpsFilterProps & {
  reportTypeControl: ReactNode;
};

export function UnassignedManifestFilters({
  reportTypeControl,
  ...props
}: UnassignedManifestFiltersProps) {
