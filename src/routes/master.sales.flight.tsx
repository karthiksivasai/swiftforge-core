...
const SEED_DATA: Omit<FlightRow, "id">[] = [
  { code: "AK066", name: "99", type: "Prime" },
  { code: "AK606", name: "AIR AISA 10", type: "Prime" },
  { code: "AK052", name: "AIR ASIA", type: "Prime" },
  { code: "GA710", name: "AIR ASIA 00", type: "Prime" },
  { code: "FD138", name: "AIR ASIA 1", type: "Prime" },
  { code: "D7202", name: "AIR ASIA 11", type: "Prime" },
  { code: "Ak068", name: "Air Asia 15", type: "Prime" },
  { code: "D7218", name: "AIR ASIA 2", type: "Prime" },
  { code: "GA716", name: "AIR ASIA 21", type: "Prime" },
  { code: "GA0716", name: "AIR ASIA 22", type: "Prime" },
  { code: "GA712", name: "AIR ASIA 225", type: "Prime" },
  { code: "AK7068", name: "AIR ASIA 25", type: "Prime" },
  { code: "NZ291", name: "AIR ASIA 3", type: "Prime" },
  { code: "GA718", name: "AIR ASIA 31", type: "Prime" },
  { code: "NZ176", name: "AIR ASIA 5", type: "Prime" },
  { code: "D7208", name: "AIR ASIA 7", type: "Prime" },
  { code: "FD398", name: "AIR ASIA A", type: "Prime" },
  { code: "FD319", name: "AIR ASIA FD319", type: "Prime" },
  { code: "D7212", name: "AIRASIA", type: "Prime" },
  { code: "SL217", name: "CUBE 2", type: "GCR" },
  { code: "6E1055", name: "CUBE 5", type: "GCR" },
  { code: "IX882", name: "CUBE PECIFIC", type: "GCR" },
  { code: "5J049", name: "CUBE PECIFIC 1", type: "GCR" },
  { code: "6E 1067", name: "FV", type: "Prime" },
  { code: "MUM", name: "MUM105045", type: "Prime" },
  { code: "UL-1174", name: "SRI", type: "Prime" },
  { code: "UL0172", name: "SRILANKA", type: "Prime" },
  { code: "0178", name: "SRILANKAN AIRLINES", type: "Prime" },
  { code: "UL0174", name: "SriLankan AirlineS 2", type: "Prime" },
  { code: "UL0604", name: "SriLankan Airlines 3", type: "Prime" },
  { code: "TG0330", name: "THAI 2", type: "Prime" },
  { code: "TG0465", name: "THAI 3", type: "Prime" },
  { code: "FD 119", name: "THAI AIR ASIA", type: "Prime" },
  { code: "TG0326", name: "THAI AIRLINE", type: "Prime" },
  { code: "TG0461", name: "THAI AIRLINES", type: "Prime" },
];

const SEED: FlightRow[] = SEED_DATA.map((s, i) => ({ id: String(i + 1), ...s }));

const PAGE_SIZE = 10;

export const Route = createFileRoute("/master/sales/flight")({
  head: () => ({
    meta: [
...
function emptyRow(): Omit<FlightRow, "id"> {
...
function FlightPage() {
  ...
  const filtered = useMemo(() => {
    ...
    return rows.filter((r) =>
      [r.code, r.name, r.type].some((v) => String(v).toLowerCase().includes(q)),
    );
  }, [rows, search]);
  ...
  const handleImportRows = async (parsedRows: CsvRecord[]) => {
    try {
      ...
      for (const rec of mapCsvToImportRows(parsedRows, flightsResource.importColumns)) {
  ...
  return (
    <div className="flex w-full flex-col gap-5 px-4 py-6 md:px-8 md:py-8">
      ...
      <div className="flex flex-col gap-1">
        <h1 className="text-2xl font-semibold tracking-tight text-foreground">Flight</h1>
        <p className="text-sm text-muted-foreground">
          Manage the flight master used for air waybill routing.
        </p>
      </div>
            ...
            <div className="flex items-center gap-1.5">
              <DataIoToolbar
                export={{
                  ...
                  title: "Flights",
                  columns: [
                    { key: "code", header: "Flight Code" },
                    { key: "name", header: "Flight Name" },
                    { key: "type", header: "Flight Type" },
                  ],
                  getRows: () =>
                    rows.map((r) => ({
                      code: r.code,
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-sidebar hover:bg-sidebar">
                <TableHead className="text-sidebar-foreground">Flight Code</TableHead>
                <TableHead className="text-sidebar-foreground">Flight Name</TableHead>
                <TableHead className="text-sidebar-foreground">Flight Type</TableHead>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-3xl">
          ...
          <div className="grid grid-cols-1 gap-5 py-2 md:grid-cols-3">
            <FieldWrapper label="Flight Code" required>
              <Input
                value={form.code}
                onChange={(e) => setForm((f) => ({ ...f, code: e.target.value }))}
                placeholder="e.g. AK066"
              />
            </FieldWrapper>

            <FieldWrapper label="Flight Name" required>
              <Input
                value={form.name}
                onChange={(e) => setForm((f) => ({ ...f, name: e.target.value }))}
                placeholder="e.g. AIR ASIA"
              />
            </FieldWrapper>

            <FieldWrapper label="Flight Type">
              <Select
                value={form.type}
                onValueChange={(v) => setForm((f) => ({ ...f, type: v as FlightType }))}
              >
                <SelectTrigger>
