/**
 * User Analysis Report — CourierWala Operations filter form.
 */
...
const DEF = REPORT_DEFINITIONS.find((r) => r.id === "user-analysis")!;

export type UserAnalysisFiltersProps = OpsFilterProps & {
  reportTypeControl: ReactNode;
};

export function UserAnalysisFilters({ reportTypeControl, ...props }: UserAnalysisFiltersProps) {
