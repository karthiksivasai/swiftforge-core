/**
 * Location Summary — CourierWala Statements filter form.
 */
...
const DEF = STATEMENT_DEFINITIONS.find((r) => r.id === "location-summary")!;

export type LocationSummaryFiltersProps = StmtFilterProps & {
  reportTypeControl: ReactNode;
};

export function LocationSummaryFilters({
  reportTypeControl,
  ...props
}: LocationSummaryFiltersProps) {
