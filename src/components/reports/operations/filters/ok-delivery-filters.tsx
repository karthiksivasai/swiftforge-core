/**
 * OK Delivery — CourierWala Operations filter form.
 */
...
const DEF = REPORT_DEFINITIONS.find((r) => r.id === "ok-delivery")!;

export type OkDeliveryFiltersProps = OpsFilterProps & {
  reportTypeControl: ReactNode;
};

export function OkDeliveryFilters({ reportTypeControl, ...props }: OkDeliveryFiltersProps) {
