/**
 * Billing Report — CourierWala AWB Report filter form.
 */
...
const DEF = AWB_REPORT_DEFINITIONS.find((r) => r.id === "billing")!;

export type BillingFiltersProps = AwbFilterProps & {
  reportTypeControl: ReactNode;
};

export function BillingFilters({ reportTypeControl, ...props }: BillingFiltersProps) {
