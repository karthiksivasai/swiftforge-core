/**
 * Vendor Profit Report — CourierWala Statements filter form.
 */
...
const DEF = STATEMENT_DEFINITIONS.find((r) => r.id === "vendor-profit")!;

export type VendorProfitFiltersProps = StmtFilterProps & {
  reportTypeControl: ReactNode;
};

export function VendorProfitFilters({ reportTypeControl, ...props }: VendorProfitFiltersProps) {
