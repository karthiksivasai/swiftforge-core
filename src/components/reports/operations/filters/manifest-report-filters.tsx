/**
 * Manifest Report — CourierWala Operations filter form.
 */
...
const DEF = REPORT_DEFINITIONS.find((r) => r.id === "manifest-report")!;

export type ManifestReportFiltersProps = OpsFilterProps & {
  reportTypeControl: ReactNode;
};

export function ManifestReportFilters({ reportTypeControl, ...props }: ManifestReportFiltersProps) {
