...
const SEED_MANIFESTS: ManifestForm[] = [
  { manifestNo: "HYD/HYD/2026/1001", manifestDate: "2026-07-04", manifestTime: "1432", manifestToServiceCenter: false, destinationServiceCenter: { code: "HYD", name: "HYD" }, vendor: { code: "WFT", name: "WORLD FRIEGT TRANSPORTATION" }, setupMode: "Select", masterAwbNo: "", location: "HYD", serviceCentre: "", connectStation: "DESTINATION", lines: [] },
  { manifestNo: "HYD/HYD/2026/1002", manifestDate: "2026-07-04", manifestTime: "1610", manifestToServiceCenter: true, destinationServiceCenter: { code: "HYD", name: "HYDERABAD" }, vendor: { code: "FEDEX", name: "FEDEX" }, setupMode: "Select", masterAwbNo: "", location: "HYD", serviceCentre: "", connectStation: "HYDERABAD", lines: [] },
  { manifestNo: "HYD/HYD/2026/1003", manifestDate: "2026-07-04", manifestTime: "1555", manifestToServiceCenter: true, destinationServiceCenter: { code: "USA", name: "USA" }, vendor: { code: "DHL1", name: "DHL LSPS" }, setupMode: "Select", masterAwbNo: "", location: "HYD", serviceCentre: "", connectStation: "USA", lines: [] },
  { manifestNo: "HYD/HYD/2026/1004", manifestDate: "2026-07-04", manifestTime: "1540", manifestToServiceCenter: false, destinationServiceCenter: { code: "UK", name: "UNITED KINGDOM" }, vendor: { code: "DHE", name: "FEDEX DL" }, setupMode: "Select", masterAwbNo: "", location: "HYD", serviceCentre: "", connectStation: "UNITED KINGDOM", lines: [] },
  { manifestNo: "HYD/HYD/2026/1005", manifestDate: "2026-07-04", manifestTime: "1525", manifestToServiceCenter: true, destinationServiceCenter: { code: "HYD", name: "HYD" }, vendor: { code: "DTAU", name: "DTDC AUSTRALIA" }, setupMode: "Select", masterAwbNo: "", location: "HYD", serviceCentre: "", connectStation: "DESTINATION", lines: [] },
  { manifestNo: "HYD/HYD/2026/1006", manifestDate: "2026-07-04", manifestTime: "1510", manifestToServiceCenter: true, destinationServiceCenter: { code: "BOM", name: "MUMBAI" }, vendor: { code: "BLUE", name: "BLUEDART" }, setupMode: "Select", masterAwbNo: "", location: "HYD", serviceCentre: "", connectStation: "HYDERABAD", lines: [] },
  { manifestNo: "HYD/HYD/2026/1007", manifestDate: "2026-07-04", manifestTime: "1455", manifestToServiceCenter: true, destinationServiceCenter: { code: "SYD", name: "SYDNEY" }, vendor: { code: "DHL", name: "DHL EXPRESS (I) PVT LTD" }, setupMode: "Select", masterAwbNo: "", location: "HYD", serviceCentre: "", connectStation: "USA", lines: [] },
  { manifestNo: "HYD/HYD/2026/1008", manifestDate: "2026-07-04", manifestTime: "1440", manifestToServiceCenter: true, destinationServiceCenter: { code: "HYD", name: "HYD" }, vendor: { code: "COUR", name: "COURIERWALA" }, setupMode: "Select", masterAwbNo: "", location: "HYD", serviceCentre: "", connectStation: "DESTINATION", lines: [] },
  { manifestNo: "HYD/HYD/2026/1009", manifestDate: "2026-07-04", manifestTime: "1425", manifestToServiceCenter: false, destinationServiceCenter: { code: "MEL", name: "MELBOURNE" }, vendor: { code: "ARX", name: "ARAMEX" }, setupMode: "Select", masterAwbNo: "", location: "HYD", serviceCentre: "", connectStation: "UNITED KINGDOM", lines: [] },
  { manifestNo: "HYD/HYD/2026/1010", manifestDate: "2026-07-04", manifestTime: "1410", manifestToServiceCenter: true, destinationServiceCenter: { code: "HYD", name: "HYD" }, vendor: { code: "CAPI", name: "CAPTAIN INDIA" }, setupMode: "Select", masterAwbNo: "", location: "HYD", serviceCentre: "", connectStation: "HYDERABAD", lines: [] },
];
