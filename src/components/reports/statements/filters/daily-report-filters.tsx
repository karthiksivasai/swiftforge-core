/**
 * Daily Report — CourierWala Statements filter form.
 */
...
const DEF = STATEMENT_DEFINITIONS.find((r) => r.id === "daily-report")!;

export type DailyReportFiltersProps = StmtFilterProps & {
  reportTypeControl: ReactNode;
};

export function DailyReportFilters({ reportTypeControl, ...props }: DailyReportFiltersProps) {
